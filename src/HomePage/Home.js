...
const Hero = () => {
  return (
    <div>
      ...
      <HeroBody>
        From coding geographic data maps to communicating insights in datasets
  ...
  return (
    <div>
      ...
      <HorizontalInfo position="first">
        <Column flexgrow="2">
          <BoldBody>Charles River Labs</BoldBody>
          <RegBody> Product Designer - Data Viz</RegBody>
          <ItalicBody>May 2023-present</ItalicBody>
        </Column>

        <Column flexgrow="5" className="descrip">
          <RegBody>
            → Responsible for the data reporting and visualization on Apollo, a
            web-based platform used by researchers running drug development
            studies.
          </RegBody>
        </Column>
      </HorizontalInfo>
      <HorizontalInfo>
        <Column flexgrow="2">
          ...
          <ItalicBody>Aug 2021-Apr 2023</ItalicBody>
        </Column>

        <Column flexgrow="5" className="descrip">
          <RegBody>
            → Made agriculture, trade and climate data accessible and
      ...
      <HorizontalInfo position="first">
        <Column flexgrow="2">
          <BoldBody> 2023 World Data Visualization Prize</BoldBody>
          <ItalicBody>Shortlist</ItalicBody>
        </Column>
        ...
        <Column flexgrow="5" className="descrip">
          <RegBody>
            ...
            or see more details about the contest{" "}
            <a
              title="World Dataviz Prize 2023 shortlist"
              target="_blank"
              rel="noopener noreferrer"
              href="https://informationisbeautiful.net/visualizations/world-dataviz-prize-2023-shortlist/"
            >
              here
            </a>
          </RegBody>
