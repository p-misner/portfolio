...
export const BoldedLink = styled.span`
    ...
    a:hover{
        background-image: linear-gradient(0deg, #6FD7ED 0%, #F4D998 22.4%, #EEB875 41.67%, #FFA534 67.19%, #F48667 96.87%);
        background-clip: text;
        color: transparent;
        
        background: -webkit-linear-gradient(0deg, #6FD7ED 0%, #F4D998 22.4%, #EEB875 41.67%, #FFA534 67.19%, #F48667 96.87%);
